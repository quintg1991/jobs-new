          ...
          <form name="addUser" method="POST" action="">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="role" name="role" <?php echo (count($usr) > 1 ? '' : 'required="required"'); ?>>
                ...
                <option <?php echo ($usr['role'] == 1 ? 'selected="selected"' : ''); ?> value="1">1</option>
                <option <?php echo ($usr['role'] == 100 ? 'selected="selected"' : ''); ?> value="100">100</option>
                <option <?php echo ($usr['role'] == 10000 ? 'selected="selected"' : ''); ?> value="10000">10000</option>
              </select>
            </div>
